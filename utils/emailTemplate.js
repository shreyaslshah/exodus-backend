const constructTemplate = (name, url, email) => {
    var message = `<html>
    <head>
        <style>
            .banner-color {
                background-color: #0e2692;
                ;
            }
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td align="left" valign="middle" width="50%"><span
                                                                    style="margin:0;color:#4c4c4c;white-space:normal;display:inline-block;text-decoration:none;font-size:12px;line-height:20px">Exodus | IEEE SBM</span></td>
                                                            <td valign="middle" width="50%" align="right"
                                                                style="padding:0 0 0 10px"><span
                                                                    style="margin:0;color:#4c4c4c;white-space:normal;display:inline-block;text-decoration:none;font-size:12px;line-height:20px"
                                                                    id="date">${Date().toString().substring(0, 24)}</span>
                                                            </td>
                                                            <td width="1">&nbsp;</td>
                                                        </tr>
                                                    </tbody>
                                                                                            ...
                                                                                            <td align="center" width="100%"
                                                                                                ...
                                                                                                <div
                                                                                                    ...
                                                                                                    <a style="padding:0.6em 1em;border-radius:600px;color:#ffffff;font-size:14px;text-decoration:none;font-weight:bold"
                                                                                                        href="${url}"
                                                                                                        class="button-color">Confirm
                                                                                                        Email</a></div>
                                                                                                        <br>
                                                                                                        <p  style="font-weight: 200; text-align: center;">Please unmark this mail from spam to avoid any further issues.</p>
                                                                                            </td>
                                                                                        </tr>
                                                                                    </tbody>
                                                                                </table>
